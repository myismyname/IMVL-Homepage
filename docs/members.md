...
<div class="member-cards">
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/zengwenjun.jpg" alt="Profile Picture">
        </div>
...
<div class="member-cards">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/baao_xie.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
...
<div class="member-cards">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/zhu_hu.png" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/刘津铭.jpg" alt="Profile Picture" class="zoom-jinming">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/chen_jiyuan.jpg" alt="Profile Picture" class="zoom-in">
        </div>
        <div class="member-card-info">
...
<div class="member-cards">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/qiuyu_chen.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/dong_yiying.jpeg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/yuntao_wei.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/zequn_zhang.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
...
<div class="member-cards">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/jianguo_huang.jpeg" alt="Profile Picture" class="zoom-jianguo">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/xudong_yang.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/eohan_g.png" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/yuyang_zhang.jpeg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/zili_lin.png" alt="Profile Picture">
        </div>
        <div class="member-card-info">
...
<div class="member-cards">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/shisheng_chen.jpeg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
    ...
    <div class="member-card">
        <div class="member-card-avatar">
            <img src="../assets/images/members/pgs/aries.jpg" alt="Profile Picture">
        </div>
        <div class="member-card-info">
...
.member-card-avatar img.zoom-in-wenjie {
    transform: scale(1.8) translateX(10%);
    object-fit: cover;
}
.member-card-avatar img.zoom-in-hongsi {
    transform: scale(4) translate(15%, -30%);
    object-fit: cover;
}
.member-card-avatar img.zoom-up {
    transform: scale(2) translate(-10%, -20%);
    object-fit: cover;
}
.member-card-avatar img.zoom-jinming {
    transform: scale(2) translate(-5%, -20%);
    object-fit: cover;
}
.member-card-avatar img.zoom-jianguo {
    transform: scale(1.5);
    object-fit: cover;
}
